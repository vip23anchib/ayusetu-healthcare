  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-800 tracking-tight">Find a Healthcare Specialist</h1>
          <p className="text-slate-500 text-sm mt-1">Book slots at AyuSetu Multispeciality Clinic by department or specialty.</p>
        </div>
        ...
        <form onSubmit={handleSearch} className="flex gap-2 w-full md:w-auto shrink-0">
          <div className="relative flex-1 md:w-80">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2.5 text-xs bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-slate-800 font-medium"
            />
          </div>
            ...
            >
              <div>
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-800">Dr. {doc.user.name}</h3>
                    <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-slate-50 text-slate-600 border border-slate-100 mt-0.5 uppercase tracking-wide">
                      {doc.specialization}
                    </span>
                  </div>
                </div>
                ...
                <div className="border-t border-slate-100 pt-4 space-y-2 text-xs text-slate-500 font-medium">
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-slate-700">{doc.slot_duration} minutes</span>
                  </div>
                  <div className="flex justify-between">
